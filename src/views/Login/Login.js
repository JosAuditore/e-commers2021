    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                <label for="email">E-mail: </label><input type="email" id="email" name="email" placeholder="Igresa tu email" onChange={handleInput} value={inputs.email}></input>
                <label for="password">Password: </label><input type="password" id="password" name="password" placeholder="Ingresa tu password" onChange={handleInput} value={inputs.password}></input>
